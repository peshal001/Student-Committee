...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function processMessage(message) {
      ...
      if (lowerMessage.includes("hello") || lowerMessage.includes("hi")) {
      ...
      } else if (lowerMessage.includes("Committee")) {
        response = "We are a student Committee focused on providing events, resources, and support for our members.";
        ...
        response = "You can reach us via email at info@studentCommittee.com or call us at +123456789.";
        ...
        response = "To join our Committee, please visit the Membership page and fill out the application form.";
        ...
        response = "Our Committee was founded to support students in their academic and personal development. Learn more about us on the About Us page.";
        ...
        response = "I'm here to help! You can ask me about our Committee, events, membership, and more.";
